...
- **[Stagehand: Between Brittle and Black Box](stagehand/)** - How Browserbase's Stagehand framework mixes deterministic code with AI-resolved instructions so browser automations survive redesigns. 5 interactive figures.
